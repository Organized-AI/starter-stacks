      ...
      <div className="container py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 font-bold text-xl mb-4">
              ...
              <span>Stack Evaluator</span>
            </div>
            <p className="text-gray-600 text-sm mb-4">
              Find the perfect tech stack for your AI project in minutes, not weeks.
            </p>
            <div className="flex gap-4">
              ...
              <Link 
                href="https://twitter.com/OrganizedAI" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-gray-600 transition-colors"
                aria-label="Twitter"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/stacks" className="text-gray-600 hover:text-gray-900 transition-colors">
                  All Stacks
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link 
                  href="https://github.com/organized-ai/starter-stacks/issues" 
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="border-t pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © 2025 Organized AI. All rights reserved.
          </p>
